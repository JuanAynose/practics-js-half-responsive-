...
button.forEach((buttons)=>{
    ...
    if(back.src.includes("desktop-image-hero-1.jpg")){
        back.src="assets/images/desktop-image-hero-2.jpg"
        title.textContent="We are available all across the globe"
        text.innerHTML="With stores all over the world, it's easy for you to find furniture for your home or place of business. Locally, we’re in most major<br> cities throughout the country. Find the branch nearest you using our store locator. Any questions? Don't hesitate to contact us today";
    }else if(back.src.includes("desktop-image-hero-2.jpg")){
        back.src="assets/images/desktop-image-hero-3.jpg"
        ...
        back.src="assets/images/desktop-image-hero-1.jpg"
